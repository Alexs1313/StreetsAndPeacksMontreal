...
import StreetsAndPeacksBackground from './StreetsAndPeacksBackground';

const streetsAndPeacksLoader = `
     <html>
      <head>
    ...
    .loader {
      ...
      -webkit-mask: linear-gradient(to bottom right, #0000 8px, #000 0 52px, #0000 0),
...
const StreetsAndPeacksLoader = () => {
  return (
    <StreetsAndPeacksBackground>
      <WebView
        originWhitelist={['*']}
        source={{ html: streetsAndPeacksLoader }}
...
export default StreetsAndPeacksLoader;
